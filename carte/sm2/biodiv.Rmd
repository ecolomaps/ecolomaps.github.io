...
#saveRDS(icon.leaf, "img/leaf.Rdata")
#icon.random<- makeAwesomeIcon(icon = 'random', markerColor = 'lightgreen', library='fa', iconColor = 'red')
#saveRDS(icon.random, "img/random.Rdata")
#icon.bug<- makeAwesomeIcon(icon = 'bug', markerColor = 'lightgreen', library='fa', iconColor = 'red')
#saveRDS(icon.bug, "img/bug.Rdata")

icon.leaf<-readRDS("img/leaf.Rdata")
icon.random<-readRDS("img/random.Rdata")
icon.bug<-readRDS("img/bug.Rdata")

```

### AGIR LOCALEMENT POUR LA PROTECTION DE LA BIODIVERSITE
...
```{r}
     ...
     proposition2 = paste0(
      ...
      " Amélioration de l'assainissement de la Marne et mise en séparatif des eaux usées pour rétablir une bonne qualité d'eaux de baignade")

       
       proposition4 = paste0(
      "<b> VALLEE DU MORBRAS",
      "</b><br/><img src='img/biodiv4.jpg' width=200px><br/>",
      "Protéger la rive gauche du Morbras (côté Sucy) de tout empiètement et limiter l'éclairage pour préserver les espèces animales sensibles à la lumière")
      ...
      "Nous proposons de rétablir les continuités écologiques qui traversent cet espace...")
              
     proposition7 = paste0(
      "<b> FORET NOTRE_DAME",
      "</b><br/><img src='img/biodiv7.jpg' width=200px><br/>",
      "Effectuer un diagnostic des arbres menacées par le réchauffement climatique et protéger les zones sensibles.")
     ...
     proposition8 = paste0(
      ...
      "Restreindre l'élagage et renforcer la naturalisation des trottoirs sur l'ensemble des voies départementales.")
